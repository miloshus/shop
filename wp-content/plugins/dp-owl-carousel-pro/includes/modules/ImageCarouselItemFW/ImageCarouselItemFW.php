...
class DPOCP_ImageCarouselItemFW extends ET_Builder_Module {

	public $slug = 'et_pb_dp_oc_custom_fw_item';
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$image_number = DPOCP_ImageCarouselFW::add_child_data( $this->props, $parent_class );
		/*
		 *
		 */
		ob_start();
